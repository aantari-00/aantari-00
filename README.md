...
- 🌱 Currently diving deep into **algorithms, system programming & full-stack web**
- 🧠 Passionate about **problem solving, low-level programming & network fundamentals**
...
int main() {
    char *name     = "Amina";
    char *school   = "1337 Coding School";
    char *passion  = "Building things from scratch";
    int   coffees  = 999; // per semester
